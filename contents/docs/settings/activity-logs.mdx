...
export const activityLogsLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/Screenshot_2026_01_19_at_15_56_10_f814e9ccbe.png";
export const activityLogsDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/Screenshot_2026_01_19_at_15_56_24_1f1bc5cecc.png";
export const activityLogsFilterLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/Screenshot_2026_01_19_at_16_10_46_8b85213cee.png";
export const activityLogsFilterDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/Screenshot_2026_01_19_at_16_10_54_d4b27f7f32.png";
export const activityLogsSidebarLight =
  "https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/Screenshot_2026_01_19_at_16_15_34_6d7eaaa13f.png";
export const activityLogsSidebarDark =
  "https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/Screenshot_2026_01_19_at_16_15_42_d7ee0e6c2b.png";
...
| SCIM configuration changed    | SCIM was enabled, disabled, or the token was rotated on a verified domain |
...
| API key created          | A new project API key or token was generated |
...
| Actor     | The user who performed the action (name, email). Actions performed via [MCP](/docs/model-context-protocol) display an **MCP** badge next to the user. |
...
<ProductScreenshot
  ...
  alt="Activity side panel showing recent changes"
  classes="rounded"
/>
...
### Sharing activity links

You can share a direct link to any activity entry.

To copy a link:

1. Hover over the activity entry
2. Click the link icon that appears
3. The URL is copied to your clipboard

When someone opens an activity link, PostHog automatically scrolls to the entry, expands its details, and highlights it briefly. This works in the **History** tab of feature flags, experiments, surveys, insights, and product tours.

## Query with PostHog AI

[PostHog AI](/docs/posthog-ai) can answer questions about your activity logs using natural language.
...
<CalloutBox icon="IconInfo" title="Requires audit logs" type="fyi">
...
**Client**
Filter by the client that originated the action. This lets you see which actions were performed via specific integrations like [MCP](/docs/model-context-protocol) (Model Context Protocol). Available client values are auto-discovered from your activity log data.
...
You can query activity logs directly using HogQL in the [SQL editor](/docs/data-warehouse/query). The `system.activity_logs` table provides programmatic access to your audit trail data.
...
- Building custom audit reports
- Analyzing change patterns across your team
- Integrating activity data with other PostHog queries

> **Note:** Only team-scoped activity logs are visible via HogQL. Organization-level logs (like membership changes) are not available in this table.
